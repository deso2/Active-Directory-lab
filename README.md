...
<p align="center">
<img src="https://imgur.com/ajlnqkf.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>

Download and install VirtualBox from the official website, considering the option of using an older build if there's a warning about the latest version.
...
<p align="center">
<img src="https://imgur.com/aZSRgBa.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
...
Configure settings: allocate RAM (at least 2GB), create a disk, set up network adapters (one for internet, one internal).
...
<p align="center">
<img src="https://imgur.com/QjBusg8.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>

 Open "Add Roles and Features" and select the server.
Choose "Active Directory Domain Services" and install.
Post-installation, click on the notification flag to promote the server to a domain controller.
Select "Add new forest" and name the domain (e.g., mydomain.com).
Proceed with default settings and set a password.
...
<p align="center">
<img src="https://imgur.com/p13t1G5.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
...
<p align="center">
<img src="https://imgur.com/bIDx2uW.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
...
<p align="center">
<img src="https://imgur.com/ywpfoGN.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
